...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: 'capture_playwright.png', fullPage: true });
    const captured = await page.evaluate(() => window.figma && typeof window.figma.captureForDesign === 'function');
