...
VTEX_STORES: dict[str, dict] = {
    ...
    "santaisabel": {
        ...
        "categories": [
            ...
            ("lacteos/yoghurt", "Lacteos / Yoghurt"),
            ("carniceria/vacuno", "Carnes / Vacuno"),
            ("chocolates-galletas-y-dulces/galletas", "Galletas"),
            ("frutas-y-verduras/frutas", "Frutas"),
            ("frutas-y-verduras/verduras", "Verduras"),
            ("vinos-cervezas-y-licores/cervezas", "Cervezas"),
            ("despensa", "Despensa"),
            ("vinos-cervezas-y-licores/vinos", "Vinos"),
        ],
    },
    "unimarc": {
        "source": "unimarc",
